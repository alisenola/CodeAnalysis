...
# Valid entity and dependency types are found in UdbSchemaC.py.
DepRules = [
  ["File", "Include", "File"],
...
def genCPPDep(udbpath,csvpath):
  print(udbpath)
  udb = depScripts.udbtools.UDB(udbpath)
  udb.setSpecs(depScripts.UdbSchemaC.Language, depScripts.UdbSchemaC.TypeMap, depScripts.UdbSchemaC.RefMap, DepRules, NoFileEnts)
  udb.dumpDeps(csvpath)

def genCPPEnt(udbpath,csvpath):
  udb = depScripts.udbtools.UDB(udbpath)
  udb.setSpecs(depScripts.UdbSchemaC.Language, depScripts.UdbSchemaC.TypeMap, depScripts.UdbSchemaC.RefMap, DepRules, NoFileEnts)
...
if __name__ == "__main__":
  ...
  genCPPDep(udbpath,depcsvpath)
  genCPPEnt(udbpath,entcsvpath)
